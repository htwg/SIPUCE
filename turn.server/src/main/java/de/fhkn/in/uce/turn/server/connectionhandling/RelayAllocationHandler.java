...
final class RelayAllocationHandler {
    ...
    public static final int MAX_PORT = 10250;
    ...
    public void handle() {
    	...
    	// TODO start relay allocation handler
        ...
        // TODO end relay allocation handler
        long end = System.currentTimeMillis();
        LOGGER.debug("Allocation Task was finished after {}", end - start);
