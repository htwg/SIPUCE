 ...
 * declared in the enum {@link Rfc3489AttributeType}.
 * 
 * @author Alexander Diener (aldiener@htwg-konstanz.de)
 * 
 */
public final class Rfc3489AttributeTypeDecoder implements AttributeTypeDecoder {

    @Override
    public AttributeType decode(final int encoded) {
        return Rfc3489AttributeType.fromEncoded(encoded);
    }
