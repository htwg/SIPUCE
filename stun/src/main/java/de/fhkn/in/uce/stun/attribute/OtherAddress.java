 ...
 * attribute according to RFC 5780.
 * 
 * <pre>
 *       0                   1                   2                   3
 ...
 * 
 */
public final class OtherAddress implements Attribute {
    ...
    /**
     * Creates a {@link OtherAddress} attribute for an endpoint.
     * 
     * @param endpoint
     *            the endpoint for the attribute
     */
    public OtherAddress(final InetSocketAddress endpoint) {
    ...
    public AttributeType getType() {
        return STUNAttributeType.OTHER_ADDRESS;
    }
    ...
    /**
     * Creates a {@link OtherAddress} from the given encoded attribute and
     * header.
     * 
     * @param encoded
     *            the encoded {@link OtherAddress} attribute
     * @param header
     *            the attribute header
     * @return the {@link OtherAddress} of the given encoding
     * @throws IOException
     *             if an I/O exception occurs
     * @throws MessageFormatException
     *             if the encoded {@link OtherAddress} is malformed
     */
    public static OtherAddress fromBytes(final byte[] encoded, final AttributeHeader header) throws IOException,
