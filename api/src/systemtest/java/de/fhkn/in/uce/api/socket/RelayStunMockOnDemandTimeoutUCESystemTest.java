...
public class RelayStunMockOnDemandTimeoutUCESystemTest extends UCESystemTest {
	...
	public UCEServerSocket createServerSocket(String sipUser, String sipServer, UCEServerSettings settings) throws IOException {
		return new UCEServerSocket(sipUser, sipServer, SERVERSETTINGS_LONG_TIMEOUT_WO_HOLE, new OnDemandConnectionStrategyFactory(), new TimeoutSocketSwitchFactory(),
				new MockRelayingClientFactory(), new MockStunEndpointFactory());
	}
	...
	public UCESocket createClientSocket(String fromUserDomain, String toUser, String toUserDomain, UCEClientSettings settings) throws UCEException {
		...
		return new UCESocket(tUsD, settings, new OnDemandConnectionStrategyFactory(), new TimeoutSocketSwitchFactory(), new MockStunEndpointFactory());
	}
