...
public class InstantTimeoutUCESystemTest extends UCESystemTest {

	@Override
	public UCEServerSocket createServerSocket(String sipUser, String sipServer, UCEServerSettings settings) throws IOException {
		return new UCEServerSocket(sipUser, sipServer, settings, new InstantConnectionStrategyFactory(), new TimeoutSocketSwitchFactory(),
	...
	public UCESocket createClientSocket(String fromUserDomain, String toUser, String toUserDomain, UCEClientSettings settings) throws UCEException {
		...
		return new UCESocket(tUsD, settings, new InstantConnectionStrategyFactory(), new TimeoutSocketSwitchFactory(), new StunEndpointFactory());
	}
}