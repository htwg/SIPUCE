...
final class OnDemandConnectionStrategyFactory implements IConnectionStrategyFactory {
	...
	public IServerConnectionHandlerStrategy createServerStrategy(IUCESipUserAgentServer sipUAS, UCEServerSettings serverSettings,
		...
		return new OnDemandServerConnectionHandlerStrategy(sipUAS, serverSettings, socketSwitchFactory, relayingClientFactory, stunEndpointFactory);
	}
}
