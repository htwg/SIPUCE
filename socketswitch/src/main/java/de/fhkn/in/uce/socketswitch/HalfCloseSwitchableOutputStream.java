...
final class HalfCloseSwitchableOutputStream extends SwitchableOutputStream {
	...
	public HalfCloseSwitchableOutputStream(Socket socket) throws IOException {
	...
	public void switchStream(Socket newSocket, int timeoutMillis)
		...
		try {
			if (currentSocket.isOutputShutdown() == false) {
