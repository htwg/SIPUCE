 ...
 */
public final class RelayingConstants {
	
	private RelayingConstants() {}
	
    public static final int DEFAULT_ALLOCATION_REFRESH_INTERVAL = 10 * 60 * 1000;
     ...
     */
    public static final int ALLOCATION_LIFETIME_MAX = 60 * 60 * 1000;
