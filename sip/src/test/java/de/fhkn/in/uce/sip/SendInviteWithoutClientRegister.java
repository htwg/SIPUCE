...
public class SendInviteWithoutClientRegister {
	...
	@Test
	public void inviteWithoutRegister() {
		try {
			synchronized (lock) {
			...
			assertEquals(OkMessage.class, queue.poll().getClass());
			assertEquals(AckMessage.class, queue.poll().getClass());
